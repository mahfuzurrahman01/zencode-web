...
export const Card = ({
  ...
  return (
    (<div
      className={cn(
        "max-w-sm w-full mx-auto p-8 rounded-xl border border-[rgba(45,45,45,0.10)] dark:bg-[rgba(40,40,40,0.70)] bg-white shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
        className
      )}>
      {children}
    </div>)
