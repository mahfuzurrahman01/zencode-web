...
export default function FollowingPointerDemo() {
  return (
    (<div className="w-80 mx-auto border border-gray-600 rounded-lg">
      <FollowerPointerCard
        title={
        ...
        <div
          ...
          <div
            ...
            {/* <Image
              src={'/demo/thumbnail.pong'}
              alt="thumbnail"
              layout="fill"
              objectFit="Container"
              className={`group-hover:scale-95 group-hover:rounded-2xl transform object-cover transition duration-200 `} /> */}
              <Image src={'/demo/thumbnail.png'} alt="thumbnail"
...
const blogContent = {
  ...
  image: "/public/demo/thumbnail.png",
